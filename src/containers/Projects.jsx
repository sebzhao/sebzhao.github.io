  ...
  return (
    <div class='mx-10 p-10 pb-10 bg-gray-200 rounded-2xl'>
        ...
        <div class = 'grid grid-cols-3 gap-4'>
            <div class='flex flex-col items-center justify-evenly p-5 m-5 shadow-lg bg-gradient-to-br from-rose-200 to-white rounded-2xl'>
            ...
            <div class='flex flex-col items-center justify-evenly p-5 m-5 shadow-lg bg-gradient-to-br from-gray-200-200 to-white rounded-2xl'>
            ...
            <div class='flex flex-col items-center justify-evenly  p-5 m-5 shadow-lg bg-gradient-to-br from-blue-200 to-white rounded-2xl'>
            ...
            <div class='flex flex-col items-center justify-evenly p-5 m-5 shadow-lg bg-gradient-to-br from-purple-200 to-white rounded-2xl'>
            ...
            <div class='flex flex-col items-center justify-evenly p-5 m-5 shadow-lg bg-gradient-to-br from-orange-200 to-white rounded-2xl'>
